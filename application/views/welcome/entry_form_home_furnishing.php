<?php include('header.php'); ?>
    ...
    <br>
      ...
      <?php endif; ?>
          ...
          <div class="card-body">   
          <h2 class="card-title">Home Furnishing</h2>
          ...
          <div class="tab-pane fade active show" id="home-02" role="tabpanel" aria-labelledby="home-02-tab">
            ...
            <?php echo form_open_multipart('Welcome/Entry_Home_furnishing'); ?>
         <!-- <form method="post" action="<?= base_url('welcome/Entry'); ?>" enctype="multipart/form-data"> -->
        ...
        <input type="hidden" class="form-control form-control-sm" name="company_type" value="Home Furnishing">
        </div>
        </div>
 ...
 <?php echo form_open_multipart('welcome/mycontrollerhomefurnishing'); ?>
