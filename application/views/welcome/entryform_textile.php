<?php include('header.php'); ?>
    ...
    <br>
      ...
      <?php endif; ?>
          ...
          <div class="card-body">   
          <h2 class="card-title">TexTile</h2>
          ...
          <div class="tab-pane fade active show" id="home-02" role="tabpanel" aria-labelledby="home-02-tab">
            ...
            <?php echo form_open_multipart('Welcome/Entry_textile'); ?>
        ...
        <input type="hidden" class="form-control form-control-sm" name="company_type" value="TexTile">
        </div>
        </div>
 ...
 <?php echo form_open_multipart('welcome/mycontrollertextile'); ?>
