...
<?php foreach ($articles as $art): ?>
 <tr>
   <td><?=  anchor("Welcome/Editdetails/{$art->id}",'Edit',['class'=>'button btn-primary']) ?></td>
...
<td>
  <?=  $art->contact_person_name; ?>
  <?=  $art->contact_person_name1; ?>
  <?=  $art->contact_person_name2; ?>
...
<td><img src="<?= $art->image; ?>" alt="" width="80" height="50" style="margin: 5px;">
