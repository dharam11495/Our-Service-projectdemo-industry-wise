     ...
     <div class="scrollbar side-menu-bg">
      <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
         ...
         <li>
          <a href="<?= base_url('admin/Show'); ?>"><i class="ti-files"></i><span class="right-nav-text">Overview</span>  </a>
          <a href="<?= base_url('admin/Mailsend'); ?>"><i class="ti-files"></i><span class="right-nav-text">Mail Send</span>  </a>
        </li>
